...
<form action="boardCreateProcess.jsp" method ="post">
<tr>
	<td>제목</td>
	<td><input type="text" name="title" id="inputtext"></td>
</tr>
<tr>
	<td ><div id="context">내용</div></td>
	<td><textarea name="post" placeholder="내용입력" id="inputtextarea" rows="30"></textarea></td>
</tr>
<tr>
	<td colspan="2" class="jointd"><input type="image" src="image/write.png" id="writeBtn"></td>
</tr>
</form>
</table>
</center>
