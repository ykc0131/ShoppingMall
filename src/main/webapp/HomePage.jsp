...
<script>
	var list =["image/home/bestitem.png","image/home/summer.png"];
	var i=0;
	function adver(){
		var s = list[i%2];
		i++;
		var imgtext = "<img src=\""+s+"\" class=\"mainimg\">";
		document.getElementById("adver").innerHTML=imgtext;
		setTimeout(adver,2300);
	}
</script>
